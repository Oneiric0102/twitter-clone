 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(V,K){var ee=V.length;V.push(K);e:for(;0<ee;){var Ie=ee-1>>>1,Se=V[Ie];if(0<i(Se,K))V[Ie]=K,V[ee]=Se,ee=Ie;else break e}}function n(V){return V.length===0?null:V[0]}function r(V){if(V.length===0)return null;var K=V[0],ee=V.pop();if(ee!==K){V[0]=ee;e:for(var Ie=0,Se=V.length,Xn=Se>>>1;Ie<Xn;){var we=2*(Ie+1)-1,Ht=V[we],lt=we+1,fn=V[lt];if(0>i(Ht,ee))lt<Se&&0>i(fn,Ht)?(V[Ie]=fn,V[lt]=ee,Ie=lt):(V[Ie]=Ht,V[we]=ee,Ie=we);else if(lt<Se&&0>i(fn,ee))V[Ie]=fn,V[lt]=ee,Ie=lt;else break e}}return K}function i(V,K){var ee=V.sortIndex-K.sortIndex;return ee!==0?ee:V.id-K.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var o=Date,a=o.now();t.unstable_now=function(){return o.now()-a}}var l=[],u=[],c=1,h=null,d=3,p=!1,v=!1,_=!1,E=typeof setTimeout=="function"?setTimeout:null,g=typeof clearTimeout=="function"?clearTimeout:null,f=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function y(V){for(var K=n(u);K!==null;){if(K.callback===null)r(u);else if(K.startTime<=V)r(u),K.sortIndex=K.expirationTime,e(l,K);else break;K=n(u)}}function m(V){if(_=!1,y(V),!v)if(n(l)!==null)v=!0,Te(S);else{var K=n(u);K!==null&&Me(m,K.startTime-V)}}function S(V,K){v=!1,_&&(_=!1,g(b),b=-1),p=!0;var ee=d;try{for(y(K),h=n(l);h!==null&&(!(h.expirationTime>K)||V&&!he());){var Ie=h.callback;if(typeof Ie=="function"){h.callback=null,d=h.priorityLevel;var Se=Ie(h.expirationTime<=K);K=t.unstable_now(),typeof Se=="function"?h.callback=Se:h===n(l)&&r(l),y(K)}else r(l);h=n(l)}if(h!==null)var Xn=!0;else{var we=n(u);we!==null&&Me(m,we.startTime-K),Xn=!1}return Xn}finally{h=null,d=ee,p=!1}}var I=!1,T=null,b=-1,q=5,F=-1;function he(){return!(t.unstable_now()-F<q)}function B(){if(T!==null){var V=t.unstable_now();F=V;var K=!0;try{K=T(!0,V)}finally{K?ne():(I=!1,T=null)}}else I=!1}var ne;if(typeof f=="function")ne=function(){f(B)};else if(typeof MessageChannel<"u"){var ye=new MessageChannel,fe=ye.port2;ye.port1.onmessage=B,ne=function(){fe.postMessage(null)}}else ne=function(){E(B,0)};function Te(V){T=V,I||(I=!0,ne())}function Me(V,K){b=E(function(){V(t.unstable_now())},K)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(V){V.callback=null},t.unstable_continueExecution=function(){v||p||(v=!0,Te(S))},t.unstable_forceFrameRate=function(V){0>V||125<V?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):q=0<V?Math.floor(1e3/V):5},t.unstable_getCurrentPriorityLevel=function(){return d},t.unstable_getFirstCallbackNode=function(){return n(l)},t.unstable_next=function(V){switch(d){case 1:case 2:case 3:var K=3;break;default:K=d}var ee=d;d=K;try{return V()}finally{d=ee}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(V,K){switch(V){case 1:case 2:case 3:case 4:case 5:break;default:V=3}var ee=d;d=V;try{return K()}finally{d=ee}},t.unstable_scheduleCallback=function(V,K,ee){var Ie=t.unstable_now();switch(typeof ee=="object"&&ee!==null?(ee=ee.delay,ee=typeof ee=="number"&&0<ee?Ie+ee:Ie):ee=Ie,V){case 1:var Se=-1;break;case 2:Se=250;break;case 5:Se=1073741823;break;case 4:Se=1e4;break;default:Se=5e3}return Se=ee+Se,V={id:c++,callback:K,priorityLevel:V,startTime:ee,expirationTime:Se,sortIndex:-1},ee>Ie?(V.sortIndex=ee,e(u,V),n(l)===null&&V===n(u)&&(_?(g(b),b=-1):_=!0,Me(m,ee-Ie))):(V.sortIndex=Se,e(l,V),v||p||(v=!0,Te(S))),V},t.unstable_shouldYield=he,t.unstable_wrapCallback=function(V){var K=d;return function(){var ee=d;d=K;try{return V.apply(this,arguments)}finally{d=ee}}}})(KE);WE.exports=KE;var JP=WE.exports;/**
 * @license React
...
`,pE=H.div`
  ...
  font-size: 1.5rem;
  color: ${t=>t.theme.colors.secondaryText};
`;function i6(){var d;const t=js(),[e,n]=x.useState([]),[r,i]=x.useState([]),[s,o]=x.useState(!0),a=t.state.showFollowers,l=((d=t==null?void 0:t.state)==null?void 0:d.targetUserId)||sessionStorage.getItem("followTargetUID")||"",u=Lr(),c=async p=>{let v=[];for(let _ of p){const E=rd(fr(mt,"users"),id("userId","==",_));try{const g=await ra(E);v.push({userId:_,nickname:g.docs[0].data().nickname})}catch{}}return v};x.useEffect(()=>{sessionStorage.setItem("followTargetUID",l),l&&(async()=>{if(a){const v=await _k(l),_=await c(v);n(_)}else{const v=await k_(l),_=await c(v);i(_)}console.log(a),console.log(r),console.log(e),o(!1)})()},[l]);const h=()=>{u(-1)};return s?P("div",{children:"Loading..."}):xe("div",{children:[xe(n6,{children:[P(t6,{onClick:h,children:P("svg",{xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24",strokeWidth:1.5,stroke:"currentColor",className:"size-6",children:P("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M10.5 19.5 3 12m0 0 7.5-7.5M3 12h18"})})}),P(r6,{children:a?"팔로우":"팔로잉"})]}),a?e.length===0?P(pE,{children:" 팔로우중인 유저가 없습니다. "}):P(fE,{children:e.map(p=>P(jg,{targetUserId:p.userId,nickname:p.nickname}))}):r.length===0?P(pE,{children:" 팔로잉한 유저가 없습니다. "}):P(fE,{children:r.map(p=>P(jg,{targetUserId:p.userId,nickname:p.nickname}))})]})}const s6=H.div`
  ${t=>t.theme.flex.columnLeftCenter};
  padding: 2.5rem 1rem;
  gap: 1rem;
`,o6=H.div`
